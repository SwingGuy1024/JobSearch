...
public interface Dao<E, PK> {
  ...
  Collection<E> getAll(@Nullable LeadField orderBy) throws SQLException;
  
  Collection<E> find(String text, @Nullable LeadField orderBy) throws SQLException;
  Collection<E> findAny(@Nullable LeadField orderBy, String... text) throws SQLException;
  Collection<E> findAll(@Nullable LeadField orderBy, String... text) throws SQLException;

  Collection<E> findInField(String text, @NonNull LeadField findBy, @Nullable LeadField orderBy) throws SQLException;
  Collection<E> findAnyInField(@NonNull LeadField findBy, @Nullable LeadField orderBy, String... text) throws SQLException;
  Collection<E> findAllInField(@NonNull LeadField findBy, @Nullable LeadField orderBy, String... text) throws SQLException;
