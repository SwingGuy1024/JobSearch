...
//    DatabaseInfo info = new DerbyInfo("/.derby.jobHuntTest");
//    info.init();
...
//    dao.insert(record2);
//
//    Collection<Record> allRecords = dao.getAll(LeadField.Source);
//    System.out.printf("getAll() returned %d records, expecting 2%n", allRecords.size());
//
//    //noinspection UnusedAssignment
//    Collection<Record> foundRecords = dao.getAll(LeadField.Source);
//    foundRecords = dao.find("t2site", LeadField.Source);
...
//    dao.update(record1);
//    foundRecords = dao.find("line", LeadField.Source);
...
//    allRecords = dao.getAll(LeadField.Source);
